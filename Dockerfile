...
RUN yum -y install telnet net-tools --disablerepo=* --enablerepo=rhel-7-server-rpms && \
yum -y update rubygems --disablerepo=* --enablerepo=rhel-7-server-rpms--disablerepo=* --enablerepo=rhel-7-server-rpms && \
yum clean all
